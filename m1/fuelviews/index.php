...
define('APPPATH', realpath(__DIR__.'/../../fuelcolor/app/').DIRECTORY_SEPARATOR);
...
define('PKGPATH', realpath(__DIR__.'/../../fuelcolor/packages/').DIRECTORY_SEPARATOR);
...
define('COREPATH', realpath(__DIR__.'/../../fuelcolor/core/').DIRECTORY_SEPARATOR);
