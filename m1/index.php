...
define('APPPATH', realpath(__DIR__.'/../../fuelM1/app/').DIRECTORY_SEPARATOR);
...
define('PKGPATH', realpath(__DIR__.'/../../fuelM1/packages/').DIRECTORY_SEPARATOR);
...
define('COREPATH', realpath(__DIR__.'/../../fuelM1/core/').DIRECTORY_SEPARATOR);
